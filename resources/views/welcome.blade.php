...
<body>
    <div class="container">
        ...
        <main>
            <div class="jumbotron">
                <div class="jumbotron-text">
                    ...
                    <button type="button" class="btn_getStarted">Mulai Petualanganmu</button>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <button class="btn_belanja" type="button"
                                    onclick='bukaModal({{ $data->id_categories }})'>Sewa</button>
                            </div>
                        </div>
                        <!-- Modal 1 -->
                            ...
                            <div class="modal-dialog" onclick="event.stopPropagation()">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title " style="color:  #ffb72b;">Formulir Penyewaan</h1>
        ...
        <footer>
            <h4>&copy; Rinjani Adventure 2024</h4>
        </footer>
    </div>
    <script>
